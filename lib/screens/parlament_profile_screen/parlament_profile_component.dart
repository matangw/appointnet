...
class ParlamentProfileComponent extends StatefulWidget {
  ...
  @override
  State<ParlamentProfileComponent> createState() =>
      _ParlamentProfileComponentState();
}

class _ParlamentProfileComponentState extends State<ParlamentProfileComponent>
    implements ParlamentProfileView {
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            ...
            child: InkWell(
              onTap: () => Navigator.pushNamed(
                  context, EditParlamentComponent.tag,
                  arguments: parlament),
              child: CircleAvatar(
                backgroundColor: MyColors().backgroundColor,
                child: Icon(
          ...
          Positioned(
            ...
            child: InkWell(
                child:
                    WidgetUtils().goBackButton(width, height * 0.15, context)),
          ),
        ],
      ),
    );
  ...
  Widget detailsContainer(double height, double width) {
    return Container(
        ...
        child:
          ...
          dataRow(width * 0.9, 'Manager', Icons.event,
              members.firstWhere((m) => m.id == parlament.managerId).name),
          dataRow(
              width * 0.9, 'Members', Icons.group, members.length.toString()),
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child:
                          WidgetUtils().customText('Link', color: Colors.white),
                    ),
                  ),
                )
              ],
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
              ...
              child:
                  WidgetUtils().customText(data, overflow: TextOverflow.clip))
        ],
      ),
    );
  }
  ...
  Widget exitGroupButton(double containerHeight, double containerWidth,
      double height, double width) {
    return InkWell(
      onTap: () => model.exitGroup(),
      child: Container(
        decoration:
            BoxDecoration(color: MyColors().backgroundColor, boxShadow: [
          BoxShadow(
          ...
          child: Center(
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  color: Colors.red),
              child: Center(
                child: WidgetUtils().customText('EXIT GROUP',
