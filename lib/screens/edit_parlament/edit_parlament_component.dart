...
class _EditParlamentComponentState extends State<EditParlamentComponent>
    implements EditParlamentView {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          child: isLoading
              ? Center(
                  child: WidgetUtils().loadingWidget(height * 0.3, width * 0.3),
                )
              : Column(
  ...
  Widget myAlertDialog(double height, double width) {
    File? imageFile =
        userImage?.path == null ? null : File(userImage?.path as String);
    return AlertDialog(
      title: Text('Are you sure you want to update the parlament ' +
          nameController.text),
      actions: [
        InkWell(
          onTap: () => {
