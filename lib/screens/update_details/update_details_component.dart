...
class _UpdateDetailsComponentState extends State<UpdateDetailsComponent>
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    textFieldWidget(height * 0.08, width * 0.6, nameController,
                        'Name:', Icons.person),
                    SizedBox(
                      height: height * 0.02,
                    ),
  ...
  Widget titleWidget(double fontSize) {
    return Column(
      ...
      children: [
        Container(
          child: WidgetUtils().customText('Please fill youre details',
              fontSize: fontSize, fontWeight: FontWeight.bold),
        ),
        Container(
          child: WidgetUtils().customText('and submit',
              fontSize: fontSize, fontWeight: FontWeight.bold),
        ),
      ],
    );
  ...
  Widget imageContainer(double radius) {
    return Container(
      decoration:
          BoxDecoration(borderRadius: BorderRadius.circular(radius * 0.1)),
  ...
  Widget textFieldWidget(double height, double width,
      TextEditingController controller, String name, IconData icon) {
    return Container(
      padding: EdgeInsets.symmetric(
          horizontal: width * 0.02, vertical: height * 0.01),
      decoration:
          BoxDecoration(borderRadius: BorderRadius.circular(height * 0.1)),
      child: Card(
        elevation: 10,
        child: Container(
          padding: EdgeInsets.symmetric(
              vertical: height * 0.1, horizontal: width * 0.02),
          height: height,
          width: width,
          child: Row(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              WidgetUtils()
                  .customText('Birth date:', fontWeight: FontWeight.bold),
              SizedBox(
                width: width * 0.08,
              ),
              Container(
                ...
                child: Center(
                    child: InkWell(
                        onTap: () => showDatePicker(
                              ...
                              lastDate:
                                  DateTime.now().subtract(Duration(days: 3649)),
                            ).then(
                                (value) => {birthDate = value, dataChanged()}),
  ...
  Widget submitButton(
    ...
    return InkWell(
      onTap: () => model.createAppointnetUser(
          userImage?.path, nameController.text, birthDate),
      child: Row(
          ...
          if (value != null)
            {
              ...
              ).then((value) => {userImage = value, dataChanged()})
            }
        });
  }
