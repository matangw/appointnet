...
class SharedPreferencesUtils {
  ...
  Future<void> setParlamentEventsIds(
      String parlamentId, List<String> ids) async {
  ...
  Future<void> setEventData(Event event) async {
    ...
    sh.setStringList(eventId + 'changesStatus', event.changesStatusIds);
  }
  ...
  Future<Event?> getEventData(String eventId) async {
    if (sh.getString(eventId) == null) {
      ...
      return Event(
          ...
          changesStatusIds:
              sh.getStringList(eventId + 'changesStatus') as List<String>,
          ...
          attendingsIds:
              sh.getStringList(eventId + 'attendings') as List<String>,
          invitedIds: sh.getStringList(
            eventId + 'invited',
          ) as List<String>,
